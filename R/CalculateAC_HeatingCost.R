...
#' @details The equation used to calculate the heating and cooling cost goes as the following: We assume the user will turn on heating if the temperature maximum is 8 degrees C. We assume the user will turn on AC if the temperature minimum is 14 degrees. Simply turning on the AC or the heater costs $10, and every additional degree above the baseline (8 C or 14 C) costs a specified price_per_degree. The default is 0.8, but this can be change by manipulating the appropriate param. This means that with every degree increase above or below the baseline temp, the cost goes up 0.8 cents. So, you will spend $10.8 if the average outdoor temp is 15 degrees.
