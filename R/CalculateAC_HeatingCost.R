...
calculate_heating_AC_cost <- function(climatedata,
...
clim_cost <- climatedata %>%
  ...
  mutate(heating_price = ifelse(tmax <= 8, (10 + abs(8 - average_temp * price_heating_per_degree)), 0))
...
plot <- ggplot(AC_heating_per_month_for_plot)+
